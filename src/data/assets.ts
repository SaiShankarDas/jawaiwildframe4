// Central repository for all project images and videos
// Replace URLs here to update media across the site instantly.
...
export const ASSETS = {
  ...
  gallery: [
    ...
    { url: "/images/5.jpeg", label: "Cultural Heritage" },
    { url: "/images/6.jpeg", label: "Misty Hills" },
    { url: "/images/7.jpeg", label: "Private Deck" },
  ...
  galleryFooter: "/images/jawai 4 (Large).jpg",
  suites: {
